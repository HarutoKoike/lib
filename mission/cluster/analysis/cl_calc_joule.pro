...
v1 = interp(v1.y, v4.x, j.x)
v3 = interp(v3.y, v3.x, j.x)
v4 = interp(v4.y, v4.x, j.x)
b1 = interp(b1.y, b4.x, j.x)
...
;b = (b1 + b3+ b4) / 3.
;
;e = mean( [ [[e1]], [[e3]], [[e4]] ], dim=2, /nan ) * 1.e-3
;v = mean( [ [[v1]], [[v3]], [[v4]] ], dim=2, /nan ) * 1.e3
;b = mean( [ [[b1]], [[b3]], [[b4]] ], dim=2, /nan ) * 1.e-9
e = e3 
v = v3
b = b3
t = j.x
...
store_data, 'E+vxB', data = {x:t, y:e_conv+e}
